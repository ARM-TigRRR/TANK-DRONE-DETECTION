...
class MeanAPEvaluator:
    ...
    def __init__(self, dataset, net, arch='mb1-ssd', eval_dir='models/eval_results',
        ...
        if arch == 'vgg16-ssd':
            ...
            raise ValueError(
                f"Invalid network architecture type '{arch}' - it should be one of:  vgg16-ssd, mb1-ssd, mb1-ssd-lite, mb2-ssd-lite, sq-ssd-lite")
    ...
    def group_annotation_by_class(self, dataset):
        ...
        for class_index in all_difficult_cases:
            for image_id in all_difficult_cases[class_index]:
                all_gt_boxes[class_index][image_id] = all_gt_boxes[class_index][
                    image_id].clone().detach()  # torch.tensor(all_gt_boxes[class_index][image_id])
...
if __name__ == '__main__':
    ...
    parser.add_argument("--eval_dir", default="models/eval_results", type=str,
    ...
    if args.net == 'vgg16-ssd':
        ...
        logging.fatal(
            f"Invalid network architecture type '{args}' - it should be one of:  vgg16-ssd, mb1-ssd, mb1-ssd-lite, mb2-ssd-lite, sq-ssd-lite")
